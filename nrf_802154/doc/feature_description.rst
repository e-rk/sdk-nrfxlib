...
The driver calculates the injected CSL phase value from the moment it ended the transmission of the PHR to the middle of the first pending delayed-reception window.
